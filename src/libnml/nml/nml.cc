...
{
	ReportNotimplement::report("NML::add_to_channel_list");
}
...
{
	ReportNotimplement::report("NML::register_with_server");
}
...
{
	ReportNotimplement::report("NML::format_output");
	return 0;
}
...
{
	ReportNotimplement::report("NML::format_input");
	return	0;
}

int NML::run_format_chain(NMLTYPE type, void *buf)
{
	ReportNotimplement::report("NML:run_format_chain");
